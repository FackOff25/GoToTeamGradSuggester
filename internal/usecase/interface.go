...
type UsecaseInterface interface {
	...
	GetMergedNearbyPlaces(cfg *config.Config, user *domain.User, location string, radius int, limit int, offset int, types []string, reactions []string) ([]domain.SuggestPlace, error)
